...
<CardGroup cols={3}>
  ...
  <Card
    title="Add Extension"
    icon="puzzle-piece"
    href="https://chromewebstore.google.com/detail/Bytespace/ckgdejddceojdljamdhjackfabldoceh"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="discord"
    href="https://discord.gg/ubc5zX5Dgx"
  >
  ...
  <Card
    ...
    href="https://discord.com/channels/1286064049863266436/1286066375739314207"
  >
...
<div className="mt-8 scale-90 opacity-80">
  ...
  <CardGroup cols={3}>
    ...
    <Card
      title="Kar (CEO)"
      icon="square-x-twitter"
      href="https://x.com/FindKar"
    />
    
    <Card
      title="Andre (CTO)"
      icon="square-x-twitter"
      href="https://x.com/andrenuyens_"
    />
  </CardGroup>
</div>
